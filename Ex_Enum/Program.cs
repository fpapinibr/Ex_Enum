    ...
    internal class Program
    {
        ...
        static string nomeDaCor(Cor c)
        {
            switch (c)
            {
                ...
                case Cor.Verde:
                    return String.Format("Verde = {0}", (int)c);

                case Cor.Azul:
                    return String.Format("Azul = {0}", (int)c);
...
// Referência para maiores estudos
// https://docs.microsoft.com/pt-br/dotnet/csharp/language-reference/language-specification/enums
